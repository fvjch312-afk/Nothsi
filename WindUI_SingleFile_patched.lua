-- WindUI single-file bundle generated from the supplied WindUI source archive.
-- Missing upstream files in the archive are bridged to the official WindUI/Icons sources.
-- Entry point: this file returns the WindUI module.

local __modules = {}
local __cache = {}

local function __normalize(base, rel)
    local parts = {}
    for p in string.gmatch(base, "[^/]+") do table.insert(parts, p) end
    table.remove(parts)
    for p in string.gmatch(rel, "[^/]+") do
        if p == "." or p == "" then
        elseif p == ".." then if #parts > 0 then table.remove(parts) end
        else table.insert(parts, p) end
    end
    return table.concat(parts, "/")
end

local function __require(base, rel)
    local path = __normalize(base, rel)
    if not path:match("%.lua$") then path = path .. ".lua" end
    if __cache[path] ~= nil then return __cache[path] end
    local factory = __modules[path]
    if not factory then error("WindUI bundled module not found: " .. path, 2) end
    local result = factory()
    __cache[path] = result
    return result
end

__modules['Icons/Main-v2.lua'] = function()
    local require = function(rel) return __require('Icons/Main-v2.lua', rel) end
...
__modules['Icons/Main.lua'] = function()
    local require = function(rel) return __require('Icons/Main.lua', rel) end
...
__modules['Init.lua'] = function()
    local require = function(rel) return __require('Init.lua', rel) end
local WindUI = {
	Window = nil,
	Theme = nil,
...
__modules['build/package.lua'] = function()
    local require = function(rel) return __require('build/package.lua', rel) end
return [[{
  "name":"windui", "version":"1.6.66", "main":"./dist/main.lua",
  "repository":"https://github.com/Footagesus/WindUI", "author":"Footagesus",
  "description":"Roblox UI Library for scripts", "license":"MIT"
}]]

end

__modules['components/KeySystem.lua'] = function()
    local require = function(rel) return __require('components/KeySystem.lua', rel) end
local URL = "https://raw.githubusercontent.com/Footagesus/WindUI/main/src/components/KeySystem.lua"
local source = game:HttpGet(URL)
return (loadstring or load)(source)()

end

__modules['components/Notification.lua'] = function()
    local require = function(rel) return __require('components/Notification.lua', rel) end
...
__modules['components/popup/Element.lua'] = function()
    local require = function(rel) return __require('components/popup/Element.lua', rel) end
local Element = {}
...
__modules['components/popup/Init.lua'] = function()
    local require = function(rel) return __require('components/popup/Init.lua', rel) end
local PopupModule = {}
...
__modules['components/search/Icons.lua'] = function()
    local require = function(rel) return __require('components/search/Icons.lua', rel) end
return { -- lucide
...
__modules['components/search/Init.lua'] = function()
    local require = function(rel) return __require('components/search/Init.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__modules['components/ui/Button.lua'] = function()
    local require = function(rel) return __require('components/ui/Button.lua', rel) end
local Button = {}
...
__modules['components/ui/Checkbox.lua'] = function()
    local require = function(rel) return __require('components/ui/Checkbox.lua', rel) end
local Checkbox = {}
...
__modules['components/ui/Code.lua'] = function()
    local require = function(rel) return __require('components/ui/Code.lua', rel) end
local Code = {}
...
__modules['components/ui/Dropdown.lua'] = function()
    local require = function(rel) return __require('components/ui/Dropdown.lua', rel) end
local DropdownMenu = {}
...
__modules['components/ui/Input.lua'] = function()
    local require = function(rel) return __require('components/ui/Input.lua', rel) end
local Input = {}
...
__modules['components/ui/Label.lua'] = function()
    local require = function(rel) return __require('components/ui/Label.lua', rel) end
local Label = {}
...
__modules['components/ui/ScrollSlider.lua'] = function()
    local require = function(rel) return __require('components/ui/ScrollSlider.lua', rel) end
local ScrollSlider = {}
...
__modules['components/ui/Tag.lua'] = function()
    local require = function(rel) return __require('components/ui/Tag.lua', rel) end
local Tag = {}
...
__modules['components/ui/Toggle.lua'] = function()
    local require = function(rel) return __require('components/ui/Toggle.lua', rel) end
local Toggle = {}
...
__modules['components/ui/Tooltip.lua'] = function()
    local require = function(rel) return __require('components/ui/Tooltip.lua', rel) end
local Tooltip = {}
...
__modules['components/window/Dialog.lua'] = function()
    local require = function(rel) return __require('components/window/Dialog.lua', rel) end
local Creator = require("../../modules/Creator")
local New = Creator.New
local Tween = Creator.Tween
...
__modules['components/window/Element.lua'] = function()
    local require = function(rel) return __require('components/window/Element.lua', rel) end
...
__modules['components/window/Init.lua'] = function()
    local require = function(rel) return __require('components/window/Init.lua', rel) end
...
__modules['components/window/Openbutton.lua'] = function()
    local require = function(rel) return __require('components/window/Openbutton.lua', rel) end
local OpenButton = {}
...
__modules['components/window/Section.lua'] = function()
    local require = function(rel) return __require('components/window/Section.lua', rel) end
local Section = {}
...
__modules['components/window/Tab.lua'] = function()
    local require = function(rel) return __require('components/window/Tab.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__modules['config/Init.lua'] = function()
    local require = function(rel) return __require('config/Init.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance) return instance end)
...
__modules['elements/Button.lua'] = function()
    local require = function(rel) return __require('elements/Button.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
function Element:New(Config)
	local Button = {
		__type = "Button", Title = Config.Title or "Button", Desc = Config.Desc or nil,
		Icon = Config.Icon or "mouse-pointer-click", IconThemed = Config.IconThemed or false,
		IconColor = Config.IconColor or nil, Color = Config.Color, Justify = Config.Justify or "Between",
		IconAlign = Config.IconAlign or "Right", Locked = Config.Locked or false, LockedTitle = Config.LockedTitle,
		Callback = Config.Callback or function() end, UIElements = {},
	}
	local CanCallback = true
	Button.ButtonFrame = require("../components/window/Element")({Title=Button.Title, Desc=Button.Desc, Parent=Config.Parent, Window=Config.Window, Color=Button.Color, Justify=Button.Justify, TextOffset=20, Hover=true, Scalable=true, Tab=Config.Tab, Index=Config.Index, ElementTable=Button, ParentConfig=Config, Size=Config.Size, Tags=Config.Tags})
	...
	if Button.IconColor then Button.UIElements.ButtonIcon.ImageLabel.ImageColor3 = Button.IconColor end
	...
	function Button:Lock() Button.Locked=true; CanCallback=false; return Button.ButtonFrame:Lock(Button.LockedTitle) end
	function Button:Unlock() Button.Locked=false; CanCallback=true; return Button.ButtonFrame:Unlock() end
	if Button.Locked then Button:Lock() end
	Creator.AddSignal(Button.ButtonFrame.UIElements.Main.MouseButton1Click, function() if CanCallback then if Config.Window and Config.Window.PlaySound then pcall(function() Config.Window:PlaySound("Button") end) end task.spawn(function() Creator.SafeCallback(Button.Callback) end) end end)
...
__modules['elements/Code.lua'] = function()
    local require = function(rel) return __require('elements/Code.lua', rel) end
local Creator = require("../modules/Creator")
local CodeComponent = require("../components/ui/Code")
local Element = {}
function Element:New(Config)
    local Code={__type="Code",Title=Config.Title,Code=Config.Code,CodeSize=Config.CodeSize or 18,Height=Config.Height,CodeTheme=Config.CodeTheme,Locked=false,CanCopied=Config.CanCopied ~= false,OnCopy=Config.OnCopy,Index=Config.Index}
    local CanCallback=not Code.Locked
    local CodeElement=CodeComponent.New(Code,Config.Window,Config.Parent,function() if CanCallback then local NewTitle=Code.Title or "code"; local success,result=pcall(function() if toclipboard then toclipboard(Code.Code) end; if setclipboard then setclipboard(Code.Code) end; if Code.OnCopy then Code.OnCopy() end end); if not success then Config.WindUI:Notify({Title="Error",Content="The "..NewTitle.." is not copied. Error: "..result,Icon="x",Duration=5}) end end end,Config.WindUI.UIScale)
    function Code:SetCode(code) CodeElement.Set(code); Code.Code=code end
    function Code:Set(code) return Code.SetCode(code) end
    function Code:Destroy() CodeElement.Destroy(); Code=nil end
    function Code.UpdateShape(Tab) if Config.Window.NewElements then local newShape=Creator:GetElementPosition(Tab.Elements,Code.Index,Config.ParentType=="HStack" or Config.ParentType=="Group"); if newShape and CodeElement.CodeFrameModule then CodeElement.CodeFrameModule:SetType(newShape); CodeElement.TopbarFrameModule:SetType(table.find({"Squircle-BL-BR","SquircleH-BL-BR"},newShape) and "Square" or newShape) end end end
    Code.UIElements={Main=CodeElement.CodeFrame}; Code.ElementFrame=CodeElement.CodeFrame
...
__modules['elements/Colorpicker.lua'] = function()
    local require = function(rel) return __require('elements/Colorpicker.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
local Tween = Creator.Tween
...
__modules['elements/Divider.lua'] = function()
    local require = function(rel) return __require('elements/Divider.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
__modules['elements/Dropdown.lua'] = function()
    local require = function(rel) return __require('elements/Dropdown.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__modules['elements/Group.lua'] = function()
    local require = function(rel) return __require('elements/Group.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
__modules['elements/HStack.lua'] = function()
    local require = function(rel) return __require('elements/HStack.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
__modules['elements/Image.lua'] = function()
    local require = function(rel) return __require('elements/Image.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
__modules['elements/Init.lua'] = function()
    local require = function(rel) return __require('elements/Init.lua', rel) end
return {
 Elements={Paragraph=require("./Paragraph"),Button=require("./Button"),Toggle=require("./Toggle"),Slider=require("./Slider"),ProgressBar=require("./ProgressBar"),Keybind=require("./Keybind"),Input=require("./Input"),Dropdown=require("./Dropdown"),Code=require("./Code"),Colorpicker=require("./Colorpicker"),Section=require("./Section"),Divider=require("./Divider"),Space=require("./Space"),Image=require("./Image"),Group=require("./Group"),HStack=require("./HStack"),VStack=require("./VStack"),Viewport=require("./Viewport")},
 Load=function(tbl,Container,Elements,Window,WindUI,OnElementCreateFunction,ElementsModule,UIScale,Tab)
  for name,module in next,Elements do tbl[name]=function(self,config) config=config or {}; config.Tab=Tab or tbl; config.ParentType=tbl.__type; config.ParentTable=tbl; config.Index=#tbl.Elements+1; config.GlobalIndex=#Window.AllElements+1; config.Parent=Container; config.Window=Window; config.WindUI=WindUI; config.UIScale=UIScale; config.ElementsModule=ElementsModule; local _,content=module:New(config); if config.Flag and typeof(config.Flag)=="string" then if Window.CurrentConfig then Window.CurrentConfig:Register(config.Flag,content) else Window.PendingFlags=Window.PendingFlags or {}; Window.PendingFlags[config.Flag]=content end end; local frame; for key,value in next,content do if typeof(value)=="table" and key~="ElementFrame" and key:match("Frame$") then frame=value; break end end; if frame then content.ElementFrame=frame.UIElements.Main; function content:SetTitle(title) return frame.SetTitle and frame:SetTitle(title) end; function content:SetDesc(desc) return frame.SetDesc and frame:SetDesc(desc) end; function content:SetImage(image,size) return frame.SetImage and frame:SetImage(image,size) end; function content:SetThumbnail(image,size) return frame.SetThumbnail and frame:SetThumbnail(image,size) end; function content:Highlight() frame:Highlight() end; function content:Destroy() frame:Destroy(); table.remove(Window.AllElements,config.GlobalIndex); table.remove(tbl.Elements,config.Index); if Tab then table.remove(Tab.Elements,config.Index) end; tbl:UpdateAllElementShapes(tbl) end end; Window.AllElements[config.Index]=content; tbl.Elements[config.Index]=content; if Tab then Tab.Elements[config.Index]=content end; if Window.NewElements then tbl:UpdateAllElementShapes(tbl) end; if OnElementCreateFunction then OnElementCreateFunction(content,tbl.Elements) end; return content end end
  function tbl:UpdateAllElementShapes(bbb) for i,element in next,bbb.Elements do local frame; for key,value in pairs(element) do if typeof(value)=="table" and key:match("Frame$") then frame=value; break end end; if not frame and element.UpdateShape then frame=element end; if frame then frame.Index=i; if frame.UpdateShape then frame.UpdateShape(bbb) end end end end
 end,
}

end

__modules['elements/Input.lua'] = function()
    local require = function(rel) return __require('elements/Input.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
local Tween = Creator.Tween
...
__modules['elements/Keybind.lua'] = function()
    local require = function(rel) return __require('elements/Keybind.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__modules['elements/Paragraph.lua'] = function()
    local require = function(rel) return __require('elements/Paragraph.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
__modules['elements/ProgressBar.lua'] = function()
    local require = function(rel) return __require('elements/ProgressBar.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
local Tween = Creator.Tween
...
__modules['elements/Section.lua'] = function()
    local require = function(rel) return __require('elements/Section.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
local Tween = Creator.Tween
...
__modules['elements/Slider.lua'] = function()
    local require = function(rel) return __require('elements/Slider.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__modules['elements/Space.lua'] = function()
    local require = function(rel) return __require('elements/Space.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
__modules['elements/Toggle.lua'] = function()
    local require = function(rel) return __require('elements/Toggle.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
local Tween = Creator.Tween
...
__modules['elements/VStack.lua'] = function()
    local require = function(rel) return __require('elements/VStack.lua', rel) end
local Creator = require("../modules/Creator")
local New = Creator.New
...
__modules['elements/Video.lua'] = function()
    local require = function(rel) return __require('elements/Video.lua', rel) end
...
__modules['elements/Viewport.lua'] = function()
    local require = function(rel) return __require('elements/Viewport.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__modules['modules/Creator.lua'] = function()
    local require = function(rel) return __require('modules/Creator.lua', rel) end
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__modules['modules/DynamicShape.lua'] = function()
    local require = function(rel) return __require('modules/DynamicShape.lua', rel) end
local Creator
...
__modules['modules/Highlighter.lua'] = function()
    local require = function(rel) return __require('modules/Highlighter.lua', rel) end
...
__modules['modules/Localization.lua'] = function()
    local require = function(rel) return __require('modules/Localization.lua', rel) end
local Localization = {}
...
__modules['themes/Fallbacks.lua'] = function()
    local require = function(rel) return __require('themes/Fallbacks.lua', rel) end
...
__modules['themes/Init.lua'] = function()
    local require = function(rel) return __require('themes/Init.lua', rel) end
...
__modules['utils/Acrylic/Blur.lua'] = function()
    local require = function(rel) return __require('utils/Acrylic/Blur.lua', rel) end
...
__modules['utils/Acrylic/Init.lua'] = function()
    local require = function(rel) return __require('utils/Acrylic/Init.lua', rel) end
...
__modules['utils/Acrylic/Paint.lua'] = function()
    local require = function(rel) return __require('utils/Acrylic/Paint.lua', rel) end
-- Credits: Fluent - Dawid
...
__modules['utils/Acrylic/Utils.lua'] = function()
    local require = function(rel) return __require('utils/Acrylic/Utils.lua', rel) end
-- Credits: Fluent - Dawid
...
__modules['utils/services/Init.lua'] = function()
    local require = function(rel) return __require('utils/services/Init.lua', rel) end
return {
    platoboost = { Name = "Platoboost", Icon = "rbxassetid://75920162824531", Args = {"ServiceId", "Secret"}, New = require("./Platoboost").New },
    pandadevelopment = { Name = "Panda Development", Icon = "panda", Args = {"ServiceId"}, New = require("./PandaDevelopment").New },
    luarmor = { Name = "Luarmor", Icon = "rbxassetid://130918283130165", Args = {"ScriptId", "Discord"}, New = require("./Luarmor").New },
    junkiedevelopment = { Name = "Junkie Development", Icon = "rbxassetid://106310347705078", Args = {"ServiceId", "ApiKey", "Provider"}, New = require("./JunkieDevelopment").New },
}

end

__modules['utils/services/JunkieDevelopment.lua'] = function()
    local require = function(rel) return __require('utils/services/JunkieDevelopment.lua', rel) end
local URL = "https://raw.githubusercontent.com/Footagesus/WindUI/main/src/utils/services/JunkieDevelopment.lua"
local source = game:HttpGet(URL)
return (loadstring or load)(source)()

end

__modules['utils/services/Luarmor.lua'] = function()
    local require = function(rel) return __require('utils/services/Luarmor.lua', rel) end
local URL = "https://raw.githubusercontent.com/Footagesus/WindUI/main/src/utils/services/Luarmor.lua"
local source = game:HttpGet(URL)
return (loadstring or load)(source)()

end

__modules['utils/services/PandaDevelopment.lua'] = function()
    local require = function(rel) return __require('utils/services/PandaDevelopment.lua', rel) end
local URL = "https://raw.githubusercontent.com/Footagesus/WindUI/main/src/utils/services/PandaDevelopment.lua"
local source = game:HttpGet(URL)
return (loadstring or load)(source)()

end

__modules['utils/services/Platoboost.lua'] = function()
    local require = function(rel) return __require('utils/services/Platoboost.lua', rel) end
local URL = "https://raw.githubusercontent.com/Footagesus/WindUI/main/src/utils/services/Platoboost.lua"
local source = game:HttpGet(URL)
return (loadstring or load)(source)()

end

return __require("Init.lua", "./Init")
